      ...
      try {
        ...
        if (loc != null && loc is Map && loc['coordinates'] is List && (loc['coordinates'] as List).length >= 2) {
          ...
          if (_currentPosition != null) {
            ...
            } else if (_currentAssignment!['distance_km'] != null && _currentAssignment!['eta_minutes'] != null) {
              _distanceToClient = (_currentAssignment!['distance_km'] as num).toDouble() * 1000;
              _etaToClient = '${_currentAssignment!['eta_minutes']} min';
            } else {
